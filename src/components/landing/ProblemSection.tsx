  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1000px] mx-auto text-center relative z-10 min-h-[160px] flex flex-col items-center justify-center">
        <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-black leading-tight flex flex-col items-center">
          <span className="relative">
            <span className="opacity-0">{fullText1}</span>
            <span className="absolute top-0 left-0 text-left whitespace-nowrap">
              {text1}
              {isVisible && text1.length < fullText1.length && (
                <span className="inline-block w-[4px] h-[40px] md:h-[60px] bg-[#fca311] ml-1 animate-pulse align-middle -mt-2 md:-mt-4"></span>
              )}
            </span>
          </span>
          <span className="relative text-prussian-blue-600 mt-2">
            <span className="opacity-0">{fullText2}</span>
            <span className="absolute top-0 left-0 text-left whitespace-nowrap text-prussian-blue-600">
              {text2}
